...
public class Config {
    ...
    private static void write(String name, BufferedWriter config) {
        ...
        sb
                ...
                .append(Params.EXCHANGE_KEY).append(" CHANGE_ME\n")
                ...
                .append(Params.GAME_SERVER_KEY).append(" CHANGE_ME\n")
                .append(Params.VERSION).append(" 1.41.9e\n")
    ...
    private enum Params {
        ...
        ENCRYPTION("system.server.encryption"),
