...
//        }
    ...
    public void disconnectInFight() {
        ...
        if (getParty() != null)
            getParty().leave(this);
        resetVars();
        // Account.disconnect() deliberately keeps logged=1 while a disconnected
        // fighter remains cached. This is the terminal eviction path.
        DatabaseManager.get(PlayerData.class).updateLogged(this.id, 0);
        DatabaseManager.get(PlayerData.class).update(this);
