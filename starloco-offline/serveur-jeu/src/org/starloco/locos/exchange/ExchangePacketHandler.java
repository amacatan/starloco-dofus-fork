                    ...
                    case 'W': //Waiting
                        switch (packet.charAt(1)) {
                            case 'A': //Add
                                ...
                                AccountData accountData = DatabaseManager.get(AccountData.class);
                                boolean reloadRequested = accountData.needsReload(id);
                                Account account = reloadRequested
                                        ? accountData.load(id)
                                        : World.world.ensureAccountLoaded(id);
                                ...
                                if (reloadRequested)
                                    accountData.clearReloadNeeded(id);
