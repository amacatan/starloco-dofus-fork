...
import org.starloco.locos.database.data.login.PetDataChecks;
import org.starloco.locos.database.data.login.PlayerDataChecks;
import org.starloco.locos.client.PlayerBankChecks;
import org.starloco.locos.client.PlayerJobActionChecks;
import org.starloco.locos.client.PlayerQuestJournalChecks;
import org.starloco.locos.client.PlayerRegenChecks;
...
import org.starloco.locos.entity.pet.PetEntryChecks;
...
import org.starloco.locos.script.DoppleLuaChecks;
import org.starloco.locos.script.EventHandlersChecks;
...
public final class GameUnitChecks {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PlayerBankChecks.run();
        PlayerJobActionChecks.run();
        PlayerQuestJournalChecks.run();
        PlayerRegenChecks.run();
        ConditionParserChecks.run();
        JobCraftChecks.run();
        ObjectTemplateChecks.run();
        EventHandlersChecks.run();
        DoppleLuaChecks.run();
        JobLuaChecks.run();
        MapLuaChecks.run();
        QuestLuaChecks.run();
