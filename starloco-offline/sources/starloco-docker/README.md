...
### Local Hosting
Use the default `.env` values for a beginner-friendly local setup, then connect a Dofus Retro 1.41.9 client.
...
| `GAME_SERVER_VERSION` | `1.41.9` | Dofus client version |
