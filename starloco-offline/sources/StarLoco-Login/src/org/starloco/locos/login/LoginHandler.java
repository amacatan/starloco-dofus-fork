...
public class LoginHandler implements IoHandler {
        ...
        if (arg0.getAttribute("client") instanceof LoginClient) {
            ...
            if(client != null) {
                for(String data : ((String) arg1).split("\n")) {
                    Console.instance.write((client.getAccount() != null ? client.getAccount().getPseudo() : "")
                            + " session " + arg0.getId() + " : recv < "
                            + LoginPacketRedactor.incoming(data, client.getStatus()));
                    client.parser(data);
                }
            }
        }
    ...
    public void messageSent(IoSession arg0, Object arg1) {
        Console.instance.write("session " + arg0.getId() + " : sent > "
                + LoginPacketRedactor.outgoing(arg1));
    }
